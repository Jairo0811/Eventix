...
public class DefaultUserService implements UserService {
    ...
    public Page<UserListItem> findAll(
            String term,
            UserStatus status,
            Pageable pageable) {
        ...
        return userRepository
                .search(normalizedTerm, status, pageable)
    ...
    public void deactivate(
        ...
        ensureAdministratorRemainsActive(
                user,
    ...
    public String resetPassword(
        ...
        if (matchesIdentity(user, authenticatedUsername)) {
            throw new BusinessRuleException(
                    ...
                    + "para actualizar tu propia cuenta.");
        }
    ...
    private void validateAdministrativeChange(
        ...
        boolean editingSelf =
                matchesIdentity(user, authenticatedUsername);
    ...
    private void ensureAdministratorRemainsActive(
        ...
        if (removesActiveAdministrator
                && userRepository
                        .countByRole_NameAndStatus(
                                RoleName.ADMINISTRATOR,
                                UserStatus.ACTIVE)
                        <= 1) {

            throw new BusinessRuleException(
                    "Eventix debe conservar al menos "
